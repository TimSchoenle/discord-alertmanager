...
```bash
docker pull timschoenle/discord-alertmanager:v0.7.0
docker pull ghcr.io/timschoenle/discord-alertmanager:v0.7.0
```
...
```bash
cosign verify ghcr.io/timschoenle/discord-alertmanager:v0.7.0 \
...
| Toolchain | 1.98.1, pinned in [rust-toolchain.toml](rust-toolchain.toml) |
