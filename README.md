...
```bash
docker pull timschoenle/discord-alertmanager:v0.6.0
docker pull ghcr.io/timschoenle/discord-alertmanager:v0.6.0
```
...
```bash
cosign verify ghcr.io/timschoenle/discord-alertmanager:v0.6.0 \
