...
```bash
docker pull timschoenle/discord-alertmanager:v0.5.0
docker pull ghcr.io/timschoenle/discord-alertmanager:v0.5.0
```
...
```bash
cosign verify ghcr.io/timschoenle/discord-alertmanager:v0.5.0 \
