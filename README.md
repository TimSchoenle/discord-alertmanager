...
```bash
docker pull timmi6790/discord-alertmanager:v0.2.0
docker pull ghcr.io/timschoenle/discord-alertmanager:v0.2.0
```
...
```bash
cosign verify ghcr.io/timschoenle/discord-alertmanager:v0.2.0 \
