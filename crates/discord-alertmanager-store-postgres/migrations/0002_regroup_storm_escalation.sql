-- Regrouping, storm digests and escalation. The SQLite backend carries the same number and
...
ALTER TABLE notifications ADD COLUMN supersedes BIGINT;
...
ALTER TABLE notifications ADD COLUMN escalated_at TIMESTAMPTZ;
...
ALTER TABLE routes ADD COLUMN escalation JSONB;
